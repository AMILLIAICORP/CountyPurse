...
const COUNTIES = [
  { name: 'Kanawha', url: 'https://www.kanawha.us/departments/finance/budget' },
  { name: 'Berkeley', url: 'https://www.berkeleywv.org/departments/finance/budget' },
  { name: 'Cabell', url: 'https://www.cabellcounty.org/finance/budget' },
  { name: 'Wood', url: 'https://www.woodcountywv.com/departments/finance/budget' },
  { name: 'Monongalia', url: 'https://www.monongaliacounty.org/finance/budget' },
  { name: 'Putnam', url: 'https://www.putnamcountywv.com/finance/budget' },
  { name: 'Raleigh', url: 'https://www.raleighcountywv.com/finance/budget' },
  { name: 'Cabell', url: 'https://www.cabellcounty.org/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, WV...')
  try {
...
async function main() {
  console.log('CountyPurse — West Virginia Budget Scraper')
