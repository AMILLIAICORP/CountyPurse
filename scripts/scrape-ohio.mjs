...
const COUNTIES = [
  { name: 'Franklin', url: 'https://www.franklincountyohio.gov/commissioners/budget' },
  { name: 'Cuyahoga', url: 'https://cuyahogacounty.gov/finance/budget' },
  { name: 'Hamilton', url: 'https://www.hamilton-co.org/budget' },
  { name: 'Summit', url: 'https://www.summitoh.net/budget' },
  { name: 'Montgomery', url: 'https://www.mcohio.org/government/departments/management_and_budget' },
  { name: 'Lucas', url: 'https://lucascountyohio.gov/budget' },
  { name: 'Butler', url: 'https://www.butlercountyohio.org/budget' },
  { name: 'Stark', url: 'https://www.starkcountyohio.gov/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, OH...')
  try {
...
async function main() {
  console.log('CountyPurse — Ohio Budget Scraper')
