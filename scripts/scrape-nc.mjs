...
const COUNTIES = [
  { name: 'Mecklenburg', url: 'https://www.mecknc.gov/CountyManagersOffice/OMB/Pages/Budget.aspx' },
  { name: 'Wake', url: 'https://www.wake.gov/departments-agencies/budget-management-services' },
  { name: 'Guilford', url: 'https://www.guilfordcountync.gov/our-county/finance/budget' },
  { name: 'Forsyth', url: 'https://www.forsyth.cc/budget' },
  { name: 'Durham', url: 'https://www.dconc.gov/government/departments-f-z/management-services/budget-management' },
  { name: 'Buncombe', url: 'https://www.buncombecounty.org/governing/depts/finance/budget.aspx' },
  { name: 'Union', url: 'https://www.unioncountync.gov/departments/finance/budget' },
  { name: 'Cabarrus', url: 'https://www.cabarruscounty.us/government/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, NC...')
  try {
...
async function main() {
  console.log('CountyPurse — North Carolina Budget Scraper')
