...
const COUNTIES = [
  { name: 'Marion', url: 'https://www.indy.gov/agency/office-of-finance-and-management' },
  { name: 'Lake', url: 'https://www.lakecountyin.org/budget' },
  { name: 'Allen', url: 'https://www.allencounty.us/budget' },
  { name: 'Hamilton', url: 'https://www.hamiltoncounty.in.gov/budget' },
  { name: 'St. Joseph', url: 'https://www.stjosephcountyindiana.com/budget' },
  { name: 'Tippecanoe', url: 'https://www.tippecanoe.in.gov/budget' },
  { name: 'Hendricks', url: 'https://www.co.hendricks.in.us/budget' },
  { name: 'Vanderburgh', url: 'https://www.evansvillegov.org/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, IN...')
  try {
...
async function main() {
  console.log('CountyPurse — Indiana Budget Scraper')
