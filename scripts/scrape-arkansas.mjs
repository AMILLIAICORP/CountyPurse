...
const COUNTIES = [
  { name: 'Pulaski', url: 'https://www.pulaskicounty.net/index.php/budget' },
  { name: 'Benton', url: 'https://www.bentoncountyar.gov/departments/finance/budget' },
  { name: 'Washington', url: 'https://www.co.washington.ar.us/departments/finance/budget' },
  { name: 'Sebastian', url: 'https://www.sebastiancounty.org/budget' },
  { name: 'Faulkner', url: 'https://www.faulknercounty.org/budget' },
  { name: 'Saline', url: 'https://www.salinecounty.org/budget' },
  { name: 'Garland', url: 'https://www.garlandcounty.org/budget' },
  { name: 'Craighead', url: 'https://www.craigheadcounty.org/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, AR...')
  try {
...
async function main() {
  console.log('CountyPurse — Arkansas Budget Scraper')
