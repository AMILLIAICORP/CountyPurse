...
const COUNTIES = [
  { name: 'Oklahoma', url: 'https://www.oklahomacounty.org/departments/finance/budget' },
  { name: 'Tulsa', url: 'https://www.tulsacounty.org/finance/budget' },
  { name: 'Cleveland', url: 'https://www.clevelandcountyok.com/budget' },
  { name: 'Canadian', url: 'https://www.canadiancountyok.gov/budget' },
  { name: 'Comanche', url: 'https://www.comanchecountyok.gov/budget' },
  { name: 'Payne', url: 'https://www.paynecountyok.gov/budget' },
  { name: 'Rogers', url: 'https://www.rogerscounty.org/budget' },
  { name: 'Wagoner', url: 'https://www.wagonercounty.ok.gov/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, OK...')
  try {
...
async function main() {
  console.log('CountyPurse — Oklahoma Budget Scraper')
