...
const COUNTIES = [
  { name: 'Hennepin', url: 'https://www.hennepin.us/your-government/budget' },
  { name: 'Ramsey', url: 'https://www.ramseycounty.us/your-government/budget' },
  { name: 'Dakota', url: 'https://www.co.dakota.mn.us/HomeFamily/Budget' },
  { name: 'Anoka', url: 'https://www.anokacounty.us/budget' },
  { name: 'Washington', url: 'https://www.co.washington.mn.us/budget' },
  { name: 'Scott', url: 'https://www.scottcountymn.gov/budget' },
  { name: 'Carver', url: 'https://www.co.carver.mn.us/departments/finance/budget' },
  { name: 'Stearns', url: 'https://www.co.stearns.mn.us/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, MN...')
  try {
...
async function main() {
  console.log('CountyPurse — Minnesota Budget Scraper')
