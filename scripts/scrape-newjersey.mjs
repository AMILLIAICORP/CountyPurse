...
const COUNTIES = [
  { name: 'Bergen', url: 'https://www.co.bergen.nj.us/finance/budget' },
  { name: 'Middlesex', url: 'https://www.middlesexcountynj.gov/government/departments/finance/budget' },
  { name: 'Essex', url: 'https://www.essexcountynj.org/finance/budget' },
  { name: 'Hudson', url: 'https://www.hudsoncountynj.org/finance/budget' },
  { name: 'Monmouth', url: 'https://www.monmouthcountyparks.com/finance/budget' },
  { name: 'Ocean', url: 'https://www.oceancountygov.com/finance/budget' },
  { name: 'Union', url: 'https://www.ucnj.org/finance/budget' },
  { name: 'Camden', url: 'https://www.camdencounty.com/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, NJ...')
  try {
...
async function main() {
  console.log('CountyPurse — New Jersey Budget Scraper')
