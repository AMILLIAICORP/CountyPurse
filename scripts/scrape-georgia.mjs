...
const COUNTIES = [
  { name: 'Fulton', url: 'https://www.fultoncountyga.gov/inside-fulton-county/fulton-county-budget' },
  { name: 'Gwinnett', url: 'https://www.gwinnettcounty.com/web/gwinnett/departments/financialservices/budget' },
  { name: 'Cobb', url: 'https://www.cobbcounty.org/finance/budget' },
  { name: 'DeKalb', url: 'https://www.dekalbcountyga.gov/finance/budget' },
  { name: 'Cherokee', url: 'https://www.cherokeega.com/budget' },
  { name: 'Forsyth', url: 'https://www.forsythco.com/Departments-Offices/Finance/Budget' },
  { name: 'Hall', url: 'https://www.hallcounty.org/260/Budget' },
  { name: 'Richmond', url: 'https://www.augustaga.gov/357/Budget' },
  { name: 'Clayton', url: 'https://www.claytoncountyga.gov/government/financial-services/budget' },
  { name: 'Savannah-Chatham', url: 'https://www.chathamcounty.org/Departments/Budget-Management' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, GA...')
  try {
...
async function main() {
  console.log('CountyPurse — Georgia Budget Scraper')
