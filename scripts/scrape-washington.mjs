...
const COUNTIES = [
  { name: 'King', url: 'https://kingcounty.gov/en/dept/exec/budget' },
  { name: 'Pierce', url: 'https://www.piercecountywa.gov/budget' },
  { name: 'Snohomish', url: 'https://snohomishcountywa.gov/budget' },
  { name: 'Spokane', url: 'https://www.spokanecounty.org/budget' },
  { name: 'Clark', url: 'https://clark.wa.gov/budget' },
  { name: 'Thurston', url: 'https://www.thurstoncountywa.gov/budget' },
  { name: 'Kitsap', url: 'https://www.kitsapgov.com/budget' },
  { name: 'Whatcom', url: 'https://www.whatcomcounty.us/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, WA...')
  try {
...
async function main() {
  console.log('CountyPurse — Washington Budget Scraper')
