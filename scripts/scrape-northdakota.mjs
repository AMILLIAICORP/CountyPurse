...
const COUNTIES = [
  { name: 'Cass', url: 'https://www.casscountynd.gov/departments/finance/budget' },
  { name: 'Burleigh', url: 'https://www.burleighco.com/departments/finance/budget' },
  { name: 'Grand Forks', url: 'https://www.gfgov.org/departments/finance/budget' },
  { name: 'Ward', url: 'https://www.wardcountynd.gov/departments/finance/budget' },
  { name: 'Morton', url: 'https://www.mortoncountynd.gov/departments/finance/budget' },
  { name: 'Stark', url: 'https://www.starkcountynd.gov/departments/finance/budget' },
  { name: 'Williams', url: 'https://www.williamsnd.com/departments/finance/budget' },
  { name: 'Stutsman', url: 'https://www.stutsmancounty.org/departments/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, ND...')
  try {
...
async function main() {
  console.log('CountyPurse — North Dakota Budget Scraper')
