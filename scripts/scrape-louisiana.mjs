...
const COUNTIES = [
  { name: 'Jefferson', url: 'https://www.jeffparish.net/departments/budget' },
  { name: 'Orleans', url: 'https://www.nola.gov/budget' },
  { name: 'East Baton Rouge', url: 'https://www.brla.gov/budget' },
  { name: 'St. Tammany', url: 'https://www.stpgov.org/departments/finance/budget' },
  { name: 'Caddo', url: 'https://www.caddo.org/departments/finance/budget' },
  { name: 'Calcasieu', url: 'https://www.calcasieu.net/departments/finance/budget' },
  { name: 'Lafayette', url: 'https://www.lafayettela.gov/finance/budget' },
  { name: 'Bossier', url: 'https://www.bossiergov.org/departments/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' Parish, LA...')
  try {
...
async function main() {
  console.log('CountyPurse — Louisiana Budget Scraper')
  console.log('Processing ' + COUNTIES.length + ' parishes...')
