...
const COUNTIES = [
  { name: 'Jefferson', url: 'https://www.jeffco.net/budget' },
  { name: 'Mobile', url: 'https://www.mobilecountyal.gov/budget' },
  { name: 'Madison', url: 'https://www.madisoncountyal.gov/departments/finance/budget' },
  { name: 'Montgomery', url: 'https://www.montgomerycountyal.gov/budget' },
  { name: 'Shelby', url: 'https://www.shelbyal.com/budget' },
  { name: 'Baldwin', url: 'https://www.baldwincountyal.gov/departments/finance/budget' },
  { name: 'Tuscaloosa', url: 'https://www.tuscaloosacounty.org/budget' },
  { name: 'Lee', url: 'https://www.leecountyalabama.gov/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, AL...')
  try {
...
async function main() {
  console.log('CountyPurse — Alabama Budget Scraper')
