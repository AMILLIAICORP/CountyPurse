...
const COUNTIES = [
  { name: 'Ada', url: 'https://adacounty.id.gov/budget' },
  { name: 'Canyon', url: 'https://www.canyonco.org/departments/finance/budget' },
  { name: 'Kootenai', url: 'https://www.kcgov.us/departments/finance/budget' },
  { name: 'Bonneville', url: 'https://www.co.bonneville.id.us/finance/budget' },
  { name: 'Twin Falls', url: 'https://www.twinfallscounty.org/departments/finance/budget' },
  { name: 'Bannock', url: 'https://www.bannockcounty.us/budget' },
  { name: 'Nez Perce', url: 'https://www.co.nezperce.id.us/budget' },
  { name: 'Cassia', url: 'https://www.cassiacounty.org/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, ID...')
  try {
...
async function main() {
  console.log('CountyPurse — Idaho Budget Scraper')
