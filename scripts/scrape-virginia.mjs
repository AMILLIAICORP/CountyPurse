...
const COUNTIES = [
  { name: 'Fairfax', url: 'https://www.fairfaxcounty.gov/budget' },
  { name: 'Prince William', url: 'https://www.pwcgov.org/budget' },
  { name: 'Loudoun', url: 'https://www.loudoun.gov/budget' },
  { name: 'Chesterfield', url: 'https://www.chesterfield.gov/budget' },
  { name: 'Henrico', url: 'https://www.henrico.gov/budget' },
  { name: 'Virginia Beach', url: 'https://www.vbgov.com/government/departments/budget' },
  { name: 'Arlington', url: 'https://www.arlingtonva.us/budget' },
  { name: 'Montgomery', url: 'https://www.montva.com/departments/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, VA...')
  try {
...
async function main() {
  console.log('CountyPurse — Virginia Budget Scraper')
