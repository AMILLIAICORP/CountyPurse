...
const COUNTIES = [
  { name: 'Wayne', url: 'https://www.waynecounty.com/government/budget/index.aspx' },
  { name: 'Oakland', url: 'https://www.oakgov.com/management-and-budget/budget' },
  { name: 'Macomb', url: 'https://www.macombgov.org/budget' },
  { name: 'Kent', url: 'https://www.accesskent.com/Departments/FiscalServices/budget.htm' },
  { name: 'Washtenaw', url: 'https://www.washtenaw.org/budget' },
  { name: 'Ingham', url: 'https://www.ingham.org/budget' },
  { name: 'Kalamazoo', url: 'https://www.kalcounty.com/finance/budget' },
  { name: 'Genesee', url: 'https://www.geneseecountymi.gov/departments/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, MI...')
  try {
...
async function main() {
  console.log('CountyPurse — Michigan Budget Scraper')
