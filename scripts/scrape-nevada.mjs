...
const COUNTIES = [
  { name: 'Clark', url: 'https://www.clarkcountynv.gov/government/departments/finance/budget' },
  { name: 'Washoe', url: 'https://www.washoecounty.gov/finance/budget' },
  { name: 'Carson City', url: 'https://www.carson.org/government/departments/finance/budget' },
  { name: 'Elko', url: 'https://www.elkocountynv.net/departments/finance/budget' },
  { name: 'Douglas', url: 'https://www.douglascountynv.gov/government/departments/finance/budget' },
  { name: 'Lyon', url: 'https://www.lyon-county.org/budget' },
  { name: 'Nye', url: 'https://www.nyecounty.net/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, NV...')
  try {
...
async function main() {
  console.log('CountyPurse — Nevada Budget Scraper')
