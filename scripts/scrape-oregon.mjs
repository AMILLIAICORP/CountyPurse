...
const COUNTIES = [
  { name: 'Multnomah', url: 'https://www.multco.us/budget' },
  { name: 'Washington', url: 'https://www.co.washington.or.us/budget' },
  { name: 'Clackamas', url: 'https://www.clackamas.us/finance/budget' },
  { name: 'Lane', url: 'https://www.lanecounty.org/cms/one.aspx?pageId=budget' },
  { name: 'Marion', url: 'https://www.co.marion.or.us/AO/budget' },
  { name: 'Jackson', url: 'https://www.jacksoncounty.org/budget' },
  { name: 'Deschutes', url: 'https://www.deschutes.org/finance/page/budget' },
  { name: 'Linn', url: 'https://www.co.linn.or.us/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, OR...')
  try {
...
async function main() {
  console.log('CountyPurse — Oregon Budget Scraper')
