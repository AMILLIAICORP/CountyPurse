...
const COUNTIES = [
  { name: 'Anchorage', url: 'https://www.muni.org/departments/budget' },
  { name: 'Fairbanks North Star', url: 'https://www.fnsb.gov/departments/finance/budget' },
  { name: 'Matanuska-Susitna', url: 'https://www.matsugov.us/departments/finance/budget' },
  { name: 'Kenai Peninsula', url: 'https://www.kpb.us/finance/budget' },
  { name: 'Juneau', url: 'https://www.juneau.org/finance/budget' },
  { name: 'Sitka', url: 'https://www.cityofsitkaalaska.us/finance/budget' },
  { name: 'Ketchikan', url: 'https://www.kgbak.us/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' Borough, AK...')
  try {
...
async function main() {
  console.log('CountyPurse — Alaska Budget Scraper')
  console.log('Processing ' + COUNTIES.length + ' boroughs...')
