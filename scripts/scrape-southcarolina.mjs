...
const COUNTIES = [
  { name: 'Greenville', url: 'https://www.greenvillecounty.org/appsuite/budget' },
  { name: 'Richland', url: 'https://www.richlandonline.com/Government/Departments/Finance-Budget' },
  { name: 'Charleston', url: 'https://www.charlestoncounty.org/departments/budget-management' },
  { name: 'Horry', url: 'https://www.horrycounty.org/departments/finance/budget' },
  { name: 'Spartanburg', url: 'https://www.spartanburgcounty.org/budget' },
  { name: 'Lexington', url: 'https://www.lex-co.com/departments/finance/budget' },
  { name: 'Anderson', url: 'https://www.andersoncountysc.org/budget' },
  { name: 'York', url: 'https://www.yorkcountygov.com/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, SC...')
  try {
...
async function main() {
  console.log('CountyPurse — South Carolina Budget Scraper')
