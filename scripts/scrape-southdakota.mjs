...
const COUNTIES = [
  { name: 'Minnehaha', url: 'https://www.minnehahacounty.org/departments/finance/budget' },
  { name: 'Pennington', url: 'https://www.penningtoncounty.org/departments/finance/budget' },
  { name: 'Lincoln', url: 'https://www.lincolncountysd.org/departments/finance/budget' },
  { name: 'Brown', url: 'https://www.brown.sd.us/departments/finance/budget' },
  { name: 'Codington', url: 'https://www.codingtoncounty.com/departments/finance/budget' },
  { name: 'Meade', url: 'https://www.meadecounty.org/departments/finance/budget' },
  { name: 'Yankton', url: 'https://www.yanktoncounty.org/departments/finance/budget' },
  { name: 'Brookings', url: 'https://www.brookingscountysd.gov/departments/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, SD...')
  try {
...
async function main() {
  console.log('CountyPurse — South Dakota Budget Scraper')
