...
const COUNTIES = [
  { name: 'Polk', url: 'https://www.polkcountyiowa.gov/finance/budget' },
  { name: 'Linn', url: 'https://www.linncounty.org/finance/budget' },
  { name: 'Scott', url: 'https://www.scottcountyiowa.gov/finance/budget' },
  { name: 'Johnson', url: 'https://www.johnsoncountyiowa.gov/finance/budget' },
  { name: 'Black Hawk', url: 'https://www.blackhawkcounty.iowa.gov/finance/budget' },
  { name: 'Woodbury', url: 'https://www.woodburycountyiowa.gov/finance/budget' },
  { name: 'Dubuque', url: 'https://www.dubuquecounty.iowa.gov/finance/budget' },
  { name: 'Story', url: 'https://www.storycounty.com/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, IA...')
  try {
...
async function main() {
  console.log('CountyPurse — Iowa Budget Scraper')
