...
const COUNTIES = [
  { name: 'Salt Lake', url: 'https://www.slco.org/budget' },
  { name: 'Utah', url: 'https://www.utahcounty.gov/dept/auditor/budget' },
  { name: 'Davis', url: 'https://www.daviscountyutah.gov/finance/budget' },
  { name: 'Weber', url: 'https://www.webercountyutah.gov/Finance/budget' },
  { name: 'Washington', url: 'https://www.washco.utah.gov/budget' },
  { name: 'Cache', url: 'https://www.cachecounty.gov/finance/budget' },
  { name: 'Iron', url: 'https://www.ironcounty.net/departments/finance/budget' },
  { name: 'Tooele', url: 'https://www.tooeleco.org/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, UT...')
  try {
...
async function main() {
  console.log('CountyPurse — Utah Budget Scraper')
