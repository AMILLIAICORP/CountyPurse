...
const COUNTIES = [
  { name: 'Philadelphia', url: 'https://www.phila.gov/departments/office-of-budget-and-program-evaluation/' },
  { name: 'Allegheny', url: 'https://www.alleghenycounty.us/county-finances/budget.aspx' },
  { name: 'Montgomery', url: 'https://www.montcopa.org/budget' },
  { name: 'Bucks', url: 'https://www.buckscounty.gov/government/departments/finance/budget' },
  { name: 'Delaware', url: 'https://www.co.delaware.pa.us/finance/budget.html' },
  { name: 'Lancaster', url: 'https://www.co.lancaster.pa.us/budget' },
  { name: 'Chester', url: 'https://www.chesco.org/budget' },
  { name: 'York', url: 'https://www.yorkcountypa.gov/government/departments/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, PA...')
  try {
...
async function main() {
  console.log('CountyPurse — Pennsylvania Budget Scraper')
