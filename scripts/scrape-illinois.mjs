...
const COUNTIES = [
  { name: 'Cook', url: 'https://www.cookcountyil.gov/agency/budget' },
  { name: 'DuPage', url: 'https://www.dupageco.org/Budget/' },
  { name: 'Lake', url: 'https://www.lakecountyil.gov/budget' },
  { name: 'Will', url: 'https://www.willcountyillinois.com/County-Departments/Finance/Budget' },
  { name: 'Kane', url: 'https://www.countyofkane.org/Finance/Pages/Budget.aspx' },
  { name: 'McHenry', url: 'https://www.mchenrycountyil.gov/county-government/departments-j-z/management-budget' },
  { name: 'Winnebago', url: 'https://www.wincoil.us/departments/finance/budget' },
  { name: 'Sangamon', url: 'https://www.co.sangamon.il.us/departments/a-e/budget-finance' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, IL...')
  try {
...
async function main() {
  console.log('CountyPurse — Illinois Budget Scraper')
