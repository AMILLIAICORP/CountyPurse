...
const COUNTIES = [
  { name: 'Douglas', url: 'https://www.douglascounty-ne.gov/departments/finance/budget' },
  { name: 'Lancaster', url: 'https://lincoln.ne.gov/city/budget' },
  { name: 'Sarpy', url: 'https://www.sarpy.gov/departments/finance/budget' },
  { name: 'Hall', url: 'https://www.hallcountyne.gov/departments/finance/budget' },
  { name: 'Buffalo', url: 'https://www.buffalocounty.ne.gov/budget' },
  { name: 'Madison', url: 'https://www.madisoncountyne.com/budget' },
  { name: 'Platte', url: 'https://www.plattecountyne.gov/budget' },
  { name: 'Lincoln', url: 'https://www.lincolncountyne.gov/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, NE...')
  try {
...
async function main() {
  console.log('CountyPurse — Nebraska Budget Scraper')
