...
const COUNTIES = [
  { name: 'Milwaukee', url: 'https://county.milwaukee.gov/EN/Administrative-Services/Budget' },
  { name: 'Dane', url: 'https://www.countyofdane.com/budget' },
  { name: 'Waukesha', url: 'https://www.waukesha.org/departments/finance/budget' },
  { name: 'Brown', url: 'https://www.browncountywi.gov/departments/finance/budget' },
  { name: 'Racine', url: 'https://www.racinecounty.com/government/departments/finance/budget' },
  { name: 'Outagamie', url: 'https://www.outagamie.org/government/departments/finance/budget' },
  { name: 'Winnebago', url: 'https://www.co.winnebago.wi.us/finance/budget' },
  { name: 'Kenosha', url: 'https://www.kenoshacounty.org/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, WI...')
  try {
...
async function main() {
  console.log('CountyPurse — Wisconsin Budget Scraper')
