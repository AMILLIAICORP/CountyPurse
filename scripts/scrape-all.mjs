...
const COUNTIES = [
  { name: 'Broward', url: 'https://www.broward.org/Budget/Pages/Default.aspx' },
  { name: 'Duval', url: 'https://www.coj.net/departments/finance/budget.aspx' },
  { name: 'Hillsborough', url: 'https://www.hillsboroughcounty.org/en/government/budget' },
  { name: 'Lee', url: 'https://www.leegov.com/budget' },
  { name: 'Manatee', url: 'https://www.mymanatee.org/departments/financial_management/budget' },
  { name: 'Miami-Dade', url: 'https://www.miamidade.gov/budget/' },
  { name: 'Pinellas', url: 'https://www.pinellascounty.org/budget/' },
  { name: 'Seminole', url: 'https://www.seminolecountyfl.gov/departments-services/resource-management/' },
  { name: 'Volusia', url: 'https://www.volusia.org/services/financial-and-administrative-services/management-and-budget/' },
]
...
async function main() {
  console.log('CountyPurse — Florida Budget Scraper')
  console.log('Processing ' + COUNTIES.length + ' counties...')
  for (const county of COUNTIES) {
    await processCounty(county)
    await new Promise(r => setTimeout(r, 2000))
  }
  console.log('Done! Check Supabase public_budgets table.')
}
