...
const COUNTIES = [
  { name: 'Denver', url: 'https://www.denvergov.org/Government/Agencies-Departments-Offices/Agencies-Departments-Offices-Directory/Budget-Management-Office' },
  { name: 'El Paso', url: 'https://www.elpasoco.com/finance/budget' },
  { name: 'Arapahoe', url: 'https://www.arapahoegov.com/budget' },
  { name: 'Jefferson', url: 'https://www.jeffco.us/budget' },
  { name: 'Adams', url: 'https://www.adcogov.org/budget' },
  { name: 'Larimer', url: 'https://www.larimer.gov/finance/budget' },
  { name: 'Boulder', url: 'https://www.bouldercounty.org/finance/budget' },
  { name: 'Douglas', url: 'https://www.douglascountyco.gov/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, CO...')
  try {
...
async function main() {
  console.log('CountyPurse — Colorado Budget Scraper')
