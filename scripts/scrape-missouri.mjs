...
const COUNTIES = [
  { name: 'St. Louis', url: 'https://stlouiscountymo.gov/st-louis-county-departments/budget' },
  { name: 'Jackson', url: 'https://www.jacksongov.org/budget' },
  { name: 'St. Charles', url: 'https://www.sccmo.org/budget' },
  { name: 'Jefferson', url: 'https://www.jeffcomo.org/budget' },
  { name: 'Greene', url: 'https://www.greenecountymo.gov/finance/budget' },
  { name: 'Clay', url: 'https://www.claycountymo.gov/budget' },
  { name: 'Boone', url: 'https://www.showmeboone.com/budget' },
  { name: 'Cass', url: 'https://www.casscounty.com/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, MO...')
  try {
...
async function main() {
  console.log('CountyPurse — Missouri Budget Scraper')
