...
const COUNTIES = [
  { name: 'Chittenden', url: 'https://www.chittendencounty.org/departments/finance/budget' },
  { name: 'Rutland', url: 'https://www.rutlandcounty.org/finance/budget' },
  { name: 'Washington', url: 'https://www.washingtonco.state.vt.us/finance/budget' },
  { name: 'Windsor', url: 'https://www.windsorCounty.org/finance/budget' },
  { name: 'Bennington', url: 'https://www.benningtoncounty.org/finance/budget' },
  { name: 'Windham', url: 'https://www.windhamcounty.org/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, VT...')
  try {
...
async function main() {
  console.log('CountyPurse — Vermont Budget Scraper')
