...
const COUNTIES = [
  { name: 'Honolulu', url: 'https://www.honolulu.gov/budget' },
  { name: 'Hawaii', url: 'https://www.hawaiicounty.gov/departments/finance/budget' },
  { name: 'Maui', url: 'https://www.mauicounty.gov/budget' },
  { name: 'Kauai', url: 'https://www.kauai.gov/Government/Departments-Agencies/Finance/Budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, HI...')
  try {
...
async function main() {
  console.log('CountyPurse — Hawaii Budget Scraper')
