...
const COUNTIES = [
  { name: 'Maricopa', url: 'https://www.maricopa.gov/budget' },
  { name: 'Pima', url: 'https://webcms.pima.gov/government/finance_and_risk_management/budget' },
  { name: 'Pinal', url: 'https://www.pinalcountyaz.gov/budget' },
  { name: 'Yavapai', url: 'https://www.yavapai.us/budget' },
  { name: 'Coconino', url: 'https://www.coconino.az.gov/budget' },
  { name: 'Mohave', url: 'https://www.mohavecounty.us/budget' },
  { name: 'Yuma', url: 'https://www.yumacountyaz.gov/government/departments/financial-services/budget' },
  { name: 'Navajo', url: 'https://www.navajocountyaz.gov/Departments/Finance/Budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, AZ...')
  try {
...
async function main() {
  console.log('CountyPurse — Arizona Budget Scraper')
