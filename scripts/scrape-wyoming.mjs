...
const COUNTIES = [
  { name: 'Laramie', url: 'https://www.laramiecounty.com/departments/finance/budget' },
  { name: 'Natrona', url: 'https://www.natronacounty.org/finance/budget' },
  { name: 'Campbell', url: 'https://www.campbellcountywy.gov/finance/budget' },
  { name: 'Sweetwater', url: 'https://www.sweetwatercounty.org/finance/budget' },
  { name: 'Albany', url: 'https://www.co.albany.wy.us/finance/budget' },
  { name: 'Fremont', url: 'https://www.fremontcountywy.org/finance/budget' },
  { name: 'Sheridan', url: 'https://www.sheridancounty.com/finance/budget' },
  { name: 'Teton', url: 'https://www.tetoncountywy.gov/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, WY...')
  try {
...
async function main() {
  console.log('CountyPurse — Wyoming Budget Scraper')
