...
const COUNTIES = [
  { name: 'Hinds', url: 'https://www.hindscountyms.com/departments/finance/budget' },
  { name: 'Harrison', url: 'https://www.harrisonco.com/departments/finance/budget' },
  { name: 'DeSoto', url: 'https://www.desotocountyms.gov/budget' },
  { name: 'Rankin', url: 'https://www.rankincounty.org/departments/finance/budget' },
  { name: 'Jackson', url: 'https://www.co.jackson.ms.us/budget' },
  { name: 'Madison', url: 'https://www.madisoncountyms.gov/budget' },
  { name: 'Forrest', url: 'https://www.forrestcounty.com/budget' },
  { name: 'Lamar', url: 'https://www.lamarcounty.com/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, MS...')
  try {
...
async function main() {
  console.log('CountyPurse — Mississippi Budget Scraper')
