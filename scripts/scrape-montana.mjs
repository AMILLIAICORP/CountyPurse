...
const COUNTIES = [
  { name: 'Yellowstone', url: 'https://www.yellowstonecountymt.gov/finance/budget' },
  { name: 'Cascade', url: 'https://www.cascadecountymt.gov/finance/budget' },
  { name: 'Missoula', url: 'https://www.missoulacounty.us/government/finance/budget' },
  { name: 'Gallatin', url: 'https://www.gallatin.mt.gov/departments/finance/budget' },
  { name: 'Flathead', url: 'https://www.flathead.mt.gov/finance/budget' },
  { name: 'Lewis and Clark', url: 'https://www.lccountymt.gov/finance/budget' },
  { name: 'Ravalli', url: 'https://www.rc.mt.gov/finance/budget' },
  { name: 'Silverbow', url: 'https://www.co.silverbow.mt.us/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, MT...')
  try {
...
async function main() {
  console.log('CountyPurse — Montana Budget Scraper')
