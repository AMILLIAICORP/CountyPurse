...
const COUNTIES = [
  { name: 'Fairfield', url: 'https://www.fairfieldct.org/finance/budget' },
  { name: 'Hartford', url: 'https://www.hartfordct.gov/Government/Departments/Finance/Budget' },
  { name: 'New Haven', url: 'https://www.newhavenct.gov/government/departments/finance/budget' },
  { name: 'Bridgeport', url: 'https://www.bridgeportct.gov/departments/finance/budget' },
  { name: 'Stamford', url: 'https://www.stamfordct.gov/government/departments/finance/budget' },
  { name: 'Waterbury', url: 'https://www.waterburyct.org/departments/finance/budget' },
  { name: 'Norwalk', url: 'https://www.norwalkct.gov/departments/finance/budget' },
  { name: 'Danbury', url: 'https://www.danburyct.gov/departments/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, CT...')
  try {
...
async function main() {
  console.log('CountyPurse — Connecticut Budget Scraper')
