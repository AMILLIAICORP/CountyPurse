...
const COUNTIES = [
  { name: 'Shelby', url: 'https://www.shelbycountytn.gov/budget' },
  { name: 'Davidson', url: 'https://www.nashville.gov/departments/finance/budget' },
  { name: 'Knox', url: 'https://www.knoxcounty.org/finance/budget.php' },
  { name: 'Hamilton', url: 'https://www.hamiltontn.gov/budget' },
  { name: 'Rutherford', url: 'https://www.rutherfordcountytn.gov/finance/budget' },
  { name: 'Williamson', url: 'https://www.williamsoncounty-tn.gov/budget' },
  { name: 'Montgomery', url: 'https://www.mcgtn.org/finance/budget' },
  { name: 'Sumner', url: 'https://www.sumnercountytn.gov/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, TN...')
  try {
...
async function main() {
  console.log('CountyPurse — Tennessee Budget Scraper')
