...
const COUNTIES = [
  { name: 'New Castle', url: 'https://www.newcastlede.gov/departments/finance/budget' },
  { name: 'Kent', url: 'https://www.co.kent.de.us/departments/finance/budget' },
  { name: 'Sussex', url: 'https://www.sussexcountyde.gov/departments/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, DE...')
  try {
...
async function main() {
  console.log('CountyPurse — Delaware Budget Scraper')
