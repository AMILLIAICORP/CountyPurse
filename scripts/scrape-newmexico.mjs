...
const COUNTIES = [
  { name: 'Bernalillo', url: 'https://www.bernco.gov/finance/budget' },
  { name: 'Dona Ana', url: 'https://www.donaanacounty.org/finance/budget' },
  { name: 'Santa Fe', url: 'https://www.santafecountynm.gov/finance/budget' },
  { name: 'Sandoval', url: 'https://www.sandovalcounty.gov/finance/budget' },
  { name: 'San Juan', url: 'https://www.sjcounty.net/departments/finance/budget' },
  { name: 'McKinley', url: 'https://www.mckinleycountynm.gov/budget' },
  { name: 'Lea', url: 'https://www.leacounty.net/budget' },
  { name: 'Chaves', url: 'https://www.chavescounty.net/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, NM...')
  try {
...
async function main() {
  console.log('CountyPurse — New Mexico Budget Scraper')
