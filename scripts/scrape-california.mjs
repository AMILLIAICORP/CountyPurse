...
const COUNTIES = [
  { name: 'Los Angeles', url: 'https://ceo.lacounty.gov/budget/' },
  { name: 'San Diego', url: 'https://www.sandiegocounty.gov/content/sdc/auditor/budget.html' },
  { name: 'Orange', url: 'https://ocgov.com/gov/ceo/budget' },
  { name: 'Riverside', url: 'https://www.rivco.org/budget' },
  { name: 'San Bernardino', url: 'https://www.sbcounty.gov/cao/budget' },
  { name: 'Santa Clara', url: 'https://www.sccgov.org/sites/opa/budget/Pages/budget.aspx' },
  { name: 'Alameda', url: 'https://www.acgov.org/government/budget.htm' },
  { name: 'Sacramento', url: 'https://www.saccounty.gov/CAO/budget/Pages/default.aspx' },
  { name: 'Contra Costa', url: 'https://www.contracosta.ca.gov/budget' },
  { name: 'Fresno', url: 'https://www.fresnocountyca.gov/Departments/Auditor-Controller-Treasurer-Tax-Collector/Budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, CA...')
  try {
...
async function main() {
  console.log('CountyPurse — California Budget Scraper')
