...
const COUNTIES = [
  { name: 'Suffolk', url: 'https://www.suffolkcountyny.gov/Departments/Budget' },
  { name: 'Nassau', url: 'https://www.nassaucountyny.gov/agencies/Budget/index.html' },
  { name: 'Westchester', url: 'https://westchestergov.com/budget' },
  { name: 'Erie', url: 'https://www2.erie.gov/budget' },
  { name: 'Monroe', url: 'https://www.monroecounty.gov/budget' },
  { name: 'Onondaga', url: 'https://www.ongov.net/mf/budget.html' },
  { name: 'Albany', url: 'https://www.albanycounty.com/departments/management-budget' },
  { name: 'Dutchess', url: 'https://www.dutchessny.gov/Departments/Budget/Budget.htm' },
  { name: 'Orange', url: 'https://www.orangecountygov.com/departments/finance/budget' },
  { name: 'Rockland', url: 'https://rocklandgov.com/departments/finance/budget-office' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, NY...')
  try {
...
async function main() {
  console.log('CountyPurse — New York Budget Scraper')
