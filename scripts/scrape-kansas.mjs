...
const COUNTIES = [
  { name: 'Johnson', url: 'https://www.jocogov.org/department/budget' },
  { name: 'Sedgwick', url: 'https://www.sedgwickcounty.org/finance/budget' },
  { name: 'Shawnee', url: 'https://www.snco.us/budget' },
  { name: 'Wyandotte', url: 'https://www.wycokck.org/departments/finance/budget' },
  { name: 'Douglas', url: 'https://douglascountyks.org/depts/financial-services/budget' },
  { name: 'Riley', url: 'https://www.rileycountyks.gov/budget' },
  { name: 'Butler', url: 'https://www.bucoks.com/departments/finance/budget' },
  { name: 'Leavenworth', url: 'https://www.leavenworthcounty.gov/departments/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, KS...')
  try {
...
async function main() {
  console.log('CountyPurse — Kansas Budget Scraper')
