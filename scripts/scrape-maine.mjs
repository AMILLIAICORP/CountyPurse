...
const COUNTIES = [
  { name: 'Cumberland', url: 'https://www.cumberlandcounty.org/finance/budget' },
  { name: 'York', url: 'https://www.yorkcountymaine.gov/finance/budget' },
  { name: 'Penobscot', url: 'https://www.penobscotcounty.org/finance/budget' },
  { name: 'Kennebec', url: 'https://www.kennebeccounty.org/finance/budget' },
  { name: 'Androscoggin', url: 'https://www.androscoggincounty.com/finance/budget' },
  { name: 'Knox', url: 'https://www.knoxcounty.org/finance/budget' },
  { name: 'Somerset', url: 'https://www.somersetcounty-me.org/finance/budget' },
  { name: 'Aroostook', url: 'https://www.aroostookcounty.org/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, ME...')
  try {
...
async function main() {
  console.log('CountyPurse — Maine Budget Scraper')
