...
const COUNTIES = [
  { name: 'Middlesex', url: 'https://www.middlesexcountyma.gov/finance/budget' },
  { name: 'Worcester', url: 'https://www.worcestercounty.org/finance/budget' },
  { name: 'Essex', url: 'https://www.essexcountyma.gov/finance/budget' },
  { name: 'Suffolk', url: 'https://www.boston.gov/departments/budget' },
  { name: 'Norfolk', url: 'https://www.norfolkcountyma.gov/finance/budget' },
  { name: 'Bristol', url: 'https://www.bristolcountyma.gov/finance/budget' },
  { name: 'Plymouth', url: 'https://www.plymouthcountyma.gov/finance/budget' },
  { name: 'Hampden', url: 'https://www.hampdencountyma.gov/finance/budget' },
]
async function processCounty(county) {
  console.log('Processing ' + county.name + ' County, MA...')
  try {
...
async function main() {
  console.log('CountyPurse — Massachusetts Budget Scraper')
